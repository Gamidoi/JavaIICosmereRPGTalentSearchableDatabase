...
@WebServlet(name = "addTalent", value = "/addTalent")
public class AddTalentToCurrentCharacterServlet extends HttpServlet {
    public void init() {
    }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int talentID = Integer.parseInt(request.getParameter("addTalentIDToCharacter"));
        try{
            PreparedStatement sqlQuery = conn.prepareStatement("insert into characterTalents values (?, ?)");
